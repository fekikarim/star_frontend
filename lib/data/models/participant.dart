...
class CreateParticipantRequest {
  ...
  factory CreateParticipantRequest.fromJson(Map<String, dynamic> json) => _$CreateParticipantRequestFromJson(json);
...
class ParticipantRanking {
  ...
  factory ParticipantRanking.fromJson(Map<String, dynamic> json) => _$ParticipantRankingFromJson(json);
