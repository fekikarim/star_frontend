...
class Challenge {
  ...
  factory Challenge.fromJson(Map<String, dynamic> json) {
    return Challenge(
      ...
      createurId: json['createurId']?.toString() ?? '',
  ...
  bool get isActive =>
      statut.toLowerCase() == 'en cours' || statut.toLowerCase() == 'actif';

  /// Check if challenge is completed
  bool get isCompleted =>
      statut.toLowerCase() == 'terminé' || statut.toLowerCase() == 'completed';

  /// Check if challenge is pending
  bool get isPending =>
      statut.toLowerCase() == 'en attente' || statut.toLowerCase() == 'pending';

  /// Check if challenge is cancelled
  bool get isCancelled =>
      statut.toLowerCase() == 'annulé' || statut.toLowerCase() == 'cancelled';
...
enum ChallengeStatusColor { active, pending, completed, cancelled, inactive }
